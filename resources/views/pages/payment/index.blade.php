            ...
            <div class="mb-4 flex flex-col gap-2 px-5 sm:flex-row sm:items-end sm:justify-end sm:px-6">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                    <div class="relative flex items-center gap-2">
                        ...
                        <div x-data="{ openSaleMassDeleteModal: false, deleteUrl: '' }">
                            <!-- Delete Selected Button -->
                            <a href="#"
                                x-on:click.prevent="
                            ...
                            <div x-show="openSaleMassDeleteModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-[400px]">
                                    ...
                                    <div class="mt-4 flex justify-end gap-3">
                                        <button @click="openSaleMassDeleteModal = false"
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="flex gap-2 mt-1">
                                                <input type="date" name="start_date"
                                                       ...
                                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-300 focus:ring focus:ring-blue-500 focus:outline-none">
                            ...
                            <td class="px-4 py-3">
                                @php
                                    $badgeClasses = [
                                        ...
                                        'Belum Dibayar Sepenuhnya' => 'bg-yellow-100 text-yellow-800',
                                ...
                                <div x-cloak x-data="{ openDropDown: false }" class="inline-block">
                                    ...
                                    <div x-show="openDropDown" @click.outside="openDropDown = false"
                                        ...
                                        <div x-data="{ openSaleDeleteModal: false }">
                                            ...
                                            <!-- Confirmation Modal -->
                                            <div x-show="openSaleDeleteModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                                                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-[400px]">
                                                    ...
                                                    <div class="flex justify-end space-x-3 mt-3">
                                                        <!-- Cancel Button -->
                                                        <button @click="openSaleDeleteModal = false" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600">
                                                            Cancel
                                                        </button>
